...
predict2_video2world_lora_training_14b_custom_data = dict(
    ...
    job=dict(
        ...
        name="14b_custom_data_carcrash_nov10",  # Name the experiment --> affect the output directory path
    ),
    model=dict(
        config=dict(
...
for _item in [
    ...
    cs.store(
        group="experiment",
        package="_global_",
        name="predict2_video2world_lora_training_finalNov10_14b",
        node=_item,
    )
