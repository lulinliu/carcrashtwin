...
# 输出
OUT_ROOT="${REPO_ROOT}/cosmos_out_ft_rw_10k_300"
mkdir -p "$OUT_ROOT"

# 模型权重（按你给的命令来，走相对路径）
DIT_PATH="/scratch/10102/hh29499/carcrashtwin/checkpoints/posttraining/real_world_10k/checkpoints/model/iter_000010000.pt"
