...
# 输出
OUT_ROOT="${REPO_ROOT}/cosmos_out_ft_rw_3k_344"
mkdir -p "$OUT_ROOT"

# 模型权重（按你给的命令来，走相对路径）
DIT_PATH="/scratch/10102/hh29499/carcrashtwin/checkpoints/posttraining/real_world_3k/checkpoints/model/iter_000003000.pt"
